...
TEST_F(Opcode_POP_Test, POP_BC_Test) {
  ...
  memory_t program = {LD_SP_D16, 0xfe,      0xff, LD_BC_D16, 0xcd,  0xab,
                      PUSH_BC,   LD_BC_D16, 0x00, 0x00,      POP_BC};
...
TEST_F(Opcode_POP_Test, POP_DE_Test) {
  /** start - inline program */
  memory_t program = {LD_SP_D16, 0xfe, 0xff,    LD_BC_D16,
                      0xcd,      0xab, PUSH_BC, POP_DE};
  memory.load_memory(program);
  cycles_t steps = 13;
  /** end   - inline program */
