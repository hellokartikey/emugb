...
TEST_F(Opcode_LD_X_D8_Test, LD_AHL_D8_Test) {
  /** start - inline program */
  memory_t program = {LD_AHL_D8, 0xab};
  memory.load_memory(program);
  cycles_t steps = 3;
  /** end   - inline program */
...
TEST_F(Opcode_LD_X_D8_Test, LD_A_D8_Test) {
  /** start - inline program */
  memory_t program = {LD_HL_D16, 0x34, 0x12, LD_A_D8, 0xab};
  memory.load_memory(program);
  cycles_t steps = 5;
  /** end   - inline program */
