...
TEST_F(Opcode_Rotates_Test, RLCA_Test) {
  ...
  memory_t program = {LD_A_D8, 0x85, RLCA};
...
TEST_F(Opcode_Rotates_Test, RRCA_Test) {
  /** start - inline program */
  memory_t program = {LD_A_D8, 0x3b, RRCA};
  memory.load_memory(program);
  cycles_t steps = 3;
  /** end   - inline program */
...
TEST_F(Opcode_Rotates_Test, RLA_Test) {
  /** start - inline program */
  memory_t program = {LD_A_D8, 0x80, RLCA, LD_A_D8, 0x95, RLA};
  memory.load_memory(program);
  cycles_t steps = 6;
  /** end   - inline program */
...
TEST_F(Opcode_Rotates_Test, RRA_Test) {
  /** start - inline program */
  memory_t program = {LD_A_D8, 0x81, RRA};
  memory.load_memory(program);
  cycles_t steps = 3;
  /** end   - inline program */
