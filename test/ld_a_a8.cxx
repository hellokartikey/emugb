...
TEST_F(Opcode_LD_A_A8_Test, LDH_A8_A_Test) {
  ...
  memory_t program = {LD_A_D8, 0xab, LDH_A8_A, 0x12};
...
TEST_F(Opcode_LD_A_A8_Test, LD_AC_A_Test) {
  /** start - inline program */
  memory_t program = {LD_A_D8, 0xab, LD_C_D8, 0x12, LD_AC_A};
  memory.load_memory(program);
  cycles_t steps = 6;
  /** end   - inline program */
...
TEST_F(Opcode_LD_A_A8_Test, LD_A_AC_Test) {
  /** start - inline program */
  memory_t program = {LD_A_D8, 0xab,    LD_C_D8, 0x12,
                      LD_AC_A, LD_A_D8, 0x00,    LD_A_AC};
  memory.load_memory(program);
  cycles_t steps = 10;
  /** end   - inline program */
...
TEST_F(Opcode_LD_A_A8_Test, LD_A16_A_Test) {
  /** start - inline program */
  memory_t program = {LD_A_D8, 0xab, LD_A16_A, 0x34, 0x12};
  memory.load_memory(program);
  cycles_t steps = 6;
  /** end   - inline program */
...
TEST_F(Opcode_LD_A_A8_Test, LD_A_A16_Test) {
  /** start - inline program */
  memory_t program = {LD_A_D8, 0xab, LD_A16_A, 0x34, 0x12,
                      LD_A_D8, 0x00, LD_A_A16, 0x34, 0x12};
  memory.load_memory(program);
  cycles_t steps = 12;
  /** end   - inline program */
