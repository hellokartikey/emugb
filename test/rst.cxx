...
TEST_F(Opcode_RST_Test, RST_00_Test) {
  ...
  memory_t program = {LD_SP_D16, 0xfe, 0xff, RST_00};
...
TEST_F(Opcode_RST_Test, RST_08_Test) {
  /** start - inline program */
  memory_t program = {LD_SP_D16, 0xfe, 0xff, RST_08};
  memory.load_memory(program);
  cycles_t steps = 7;
  /** end   - inline program */
...
TEST_F(Opcode_RST_Test, RST_10_Test) {
  /** start - inline program */
  memory_t program = {LD_SP_D16, 0xfe, 0xff, RST_10};
  memory.load_memory(program);
  cycles_t steps = 7;
  /** end   - inline program */
...
TEST_F(Opcode_RST_Test, RST_18_Test) {
  /** start - inline program */
  memory_t program = {LD_SP_D16, 0xfe, 0xff, RST_18};
  memory.load_memory(program);
  cycles_t steps = 7;
  /** end   - inline program */
...
TEST_F(Opcode_RST_Test, RST_20_Test) {
  /** start - inline program */
  memory_t program = {LD_SP_D16, 0xfe, 0xff, RST_20};
  memory.load_memory(program);
  cycles_t steps = 7;
  /** end   - inline program */
...
TEST_F(Opcode_RST_Test, RST_28_Test) {
  /** start - inline program */
  memory_t program = {LD_SP_D16, 0xfe, 0xff, RST_28};
  memory.load_memory(program);
  cycles_t steps = 7;
  /** end   - inline program */
...
TEST_F(Opcode_RST_Test, RST_30_Test) {
  /** start - inline program */
  memory_t program = {LD_SP_D16, 0xfe, 0xff, RST_30};
  memory.load_memory(program);
  cycles_t steps = 7;
  /** end   - inline program */
...
TEST_F(Opcode_RST_Test, RST_38_Test) {
  /** start - inline program */
  memory_t program = {LD_SP_D16, 0xfe, 0xff, RST_38};
  memory.load_memory(program);
  cycles_t steps = 7;
  /** end   - inline program */
