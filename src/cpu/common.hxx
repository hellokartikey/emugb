...
namespace gb {
    ...
    LD_A_D8 = 0x3E, LD_A_AHL = 0x7E,

    LD_B_B = 0x40, LD_B_C = 0x41, LD_B_D = 0x42, LD_B_E = 0x43,
    LD_B_H = 0x44, LD_B_L = 0x45, LD_B_A = 0x47,
    LD_B_D8 = 0x06, LD_B_AHL = 0x46,

    LD_C_B = 0x48, LD_C_C = 0x49, LD_C_D = 0x4A, LD_C_E = 0x4B,
    LD_C_H = 0x4C, LD_C_L = 0x4D, LD_C_A = 0x4F,
    LD_C_D8 = 0x0E, LD_C_AHL = 0x4E,

    LD_D_B = 0x50, LD_D_C = 0x51, LD_D_D = 0x52, LD_D_E = 0x53,
    LD_D_H = 0x54, LD_D_L = 0x55, LD_D_A = 0x57,
    LD_D_D8 = 0x16, LD_D_AHL = 0x56,

    LD_E_B = 0x58, LD_E_C = 0x59, LD_E_D = 0x5A, LD_E_E = 0x5B,
    LD_E_H = 0x5C, LD_E_L = 0x5D, LD_E_A = 0x5F,
    LD_E_D8 = 0x1E, LD_E_AHL = 0x5E,

    LD_H_B = 0x60, LD_H_C = 0x61, LD_H_D = 0x62, LD_H_E = 0x63,
    LD_H_H = 0x64, LD_H_L = 0x65, LD_H_A = 0x67,
    LD_H_D8 = 0x26, LD_H_AHL = 0x66,

    LD_L_B = 0x68, LD_L_C = 0x69, LD_L_D = 0x6A, LD_L_E = 0x6B,
    LD_L_H = 0x6C, LD_L_L = 0x6D, LD_L_A = 0x6F,
    LD_L_D8 = 0x2E, LD_L_AHL = 0x6E,

    LD_AHL_B = 0x70, LD_AHL_C = 0x71, LD_AHL_D = 0x72, LD_AHL_E = 0x73,
    LD_AHL_H = 0x74, LD_AHL_L = 0x75, LD_AHL_A = 0x77,
    LD_AHL_D8 = 0x36,
    LD_AHLP_A = 0x22, LD_A_AHLP = 0x2A,
    LD_AHLM_A = 0x32, LD_A_AHLM = 0x3A,

    LD_ABC_A = 0x02, LD_A_ABC = 0x0A,
    LD_ADE_A = 0x12, LD_A_ADE = 0x1A,
    ...
    ADD_A_D8 = 0xC6, ADD_A_AHL = 0x86,

    SUB_B = 0x90, SUB_C = 0x91, SUB_D = 0x92, SUB_E = 0x93,
    SUB_H = 0x94, SUB_L = 0x95, SUB_A = 0x97,
    SUB_D8 = 0xD6, SUB_AHL = 0x96,

    AND_B = 0xA0, AND_C = 0xA1, AND_D = 0xA2, AND_E = 0xA3,
    AND_H = 0xA4, AND_L = 0xA5, AND_A = 0xA7,
    AND_D8 = 0xE6, AND_AHL = 0xA6,

    OR_B = 0xB0, OR_C = 0xB1, OR_D = 0xB2, OR_E = 0xB3,
    OR_H = 0xB4, OR_L = 0xB5, OR_A = 0xB7,
    OR_D8 = 0xF6, OR_AHL = 0xB6,

    ADC_A_B = 0x88, ADC_A_C = 0x89, ADC_A_D = 0x8A, ADC_A_E = 0x8B,
    ADC_A_H = 0x8C, ADC_A_L = 0x8D, ADC_A_A = 0x8F,
    ADC_A_D8 = 0xCE, ADC_A_AHL = 0x8E,

    SBC_A_B = 0x98, SBC_A_C = 0x99, SBC_A_D = 0x9A, SBC_A_E = 0x9B,
    SBC_A_H = 0x9C, SBC_A_L = 0x9D, SBC_A_A = 0x9F,
    SBC_A_D8 = 0xDE, SBC_A_AHL = 0x9E,

    XOR_B = 0xA8, XOR_C = 0xA9, XOR_D = 0xAA, XOR_E = 0xAB,
    XOR_H = 0xAC, XOR_L = 0xAD, XOR_A = 0xAF,
    XOR_D8 = 0xEE, XOR_AHL = 0xAE,

    CP_B = 0xB8, CP_C = 0xB9, CP_D = 0xBA, CP_E = 0xBB,
    CP_H = 0xBC, CP_L = 0xBD, CP_A = 0xBF,
    CP_D8 = 0xFE, CP_AHL = 0xBE,
